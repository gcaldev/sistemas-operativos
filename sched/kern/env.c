...
env_free(struct Env *e)
{
	...
	// Resetear el número de CPU para este entorno.
	e->env_cpunum = -1;
...
env_run(struct Env *e)
{
	...
	// K
	// cprintf("id: %d, runs: %d, prior: %d, cpu: %d\n", curenv->env_id,
	// curenv->env_runs, curenv->env_priority, curenv->env_cpunum); if
	// (curenv->env_runs == 50) 	panic("falla");

	// if (curenv->env_priority < 100)
	//	curenv->env_priority++;
